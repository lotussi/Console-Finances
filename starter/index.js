...
// console.log(arrayOfNumbers.length) // logs 5
// console.log(arrayOfNumbers[2]) // logs 3
// console.log(arrayOfNumbers[4])

// var i = 1

// console.log(arrayOfNumbers[i]) // logs 2
...
// console.log(finances[1]) // logs ['Feb-2010', 984655]
// console.log(finances[1][0]) // logs 'Feb-2010'
// console.log(finances[3][1])


//console.log("This is the sum: ", totalSum)
...
for (var i = 1; i < finances.length; i++) {
    var currentBalance = finances[i][1]
    var previousBalance = finances[i-1][1]

    var changeInProfit = currentBalance - previousBalance
    //console.log(Math.abs(changeInProfit));
...
// const endDate = new Date(2017, 3, 1); // march 1st 2017 -is this correct to put end date as the beginning of next month? 
...
//you will need to track what the total change in profits are from month and then find the average.
//(Total/Number of months).
//calculate differences between !st and 2nd income in the array.
//log this.
//then calculate difference between 2nd and 3rd income in the array.
//log this
//continue logging last previous and next number.
//log each time.
//repeat untill end of string
//total/number of changes ===> total changes/(month - 1)
//array?using .push?
//print to console
